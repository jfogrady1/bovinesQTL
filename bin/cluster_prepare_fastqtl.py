...
if __name__=='__main__':
    ...
    subprocess.check_call(
        ...
        +' --ChromosomeBlackList /home/workspace/jogrady/bovinesQTL/data/Bos_taurus.ARS-UCD1.2.110.blacklist.txt' \
    ...
    bed_df['chr_ix'] = bed_df['#Chr'].str.replace('chr','').str.replace('X','30').astype(np.int32)
    for c in ['start', 'end']:
